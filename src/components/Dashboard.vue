	...
	},
	{
		...
		instructions: [
			new SpeechInstruction({
				...
				targetValue: 'START',
				duration: 4000,
				negativeReinforcement: { enabled: false }
			}),
			new SpeechInstruction({
				id: 'v2',
				prompt: 'Say "FOCUS"',
...

	{
		...
		instructions: [
			new FractionationInstruction({
				id: 'f1',
				prompt: 'Relax and follow the voice',
				cycles: 3
			}),
			new TypeInstruction({
				id: 't1',
				prompt: 'Type "I obey"',
				targetPhrase: 'I obey',
				positiveReinforcement: { message: 'ACCEPTED' },
				negativeReinforcement: { message: 'TRY AGAIN' }
			}),
			new NodInstruction({
				id: 'n1',
			...
			new TypeInstruction({
				id: 't2',
				prompt: 'Type "My mind is open"',
				targetPhrase: 'My mind is open',
				positiveReinforcement: { message: 'ACCEPTED' },
				negativeReinforcement: { message: 'TRY AGAIN' }
			}),
