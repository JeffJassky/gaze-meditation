...
export const somaticResetReadOnly: Session = {
	...
	scenes: [
		...
		{ text: 'D  R  I  F  T  I  N  G', behavior: { suggestions: [{ type: 'head:still', duration: 30000 }] } },
		{ text: 'S  I  N  K  I  N  G', behavior: { suggestions: [{ type: 'head:still', duration: 30000 }] } },
		{ text: 'S  I  L  E  N  C  E', behavior: { suggestions: [{ type: 'head:still', duration: 30000 }] } },
		{ text: 'S  P  A  C  E', behavior: { suggestions: [{ type: 'head:still', duration: 30000 }] } },
