...
export abstract class Behavior<TOptions extends BehaviorOptions = BehaviorOptions> extends EventTarget {
	...
	/**
	 * Device references injected by Scene before `start()` is called.
	 * Behaviors access devices via `this.devices` rather than importing
	 * the module-level singletons, enabling testability and swappability.
	 */
	public devices!: DeviceContext
