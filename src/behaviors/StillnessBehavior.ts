...
export class StillnessBehavior extends Behavior<StillnessBehaviorOptions> {
	...
	protected onStart(): void {
		this.addManagedEventListener(this.devices.headRegion, 'stillness', this.handleStillness)
		this.addManagedEventListener(this.devices.headRegion, 'unstable', this.handleUnstable)
		this.devices.camera.start().catch(e => {
