<template>
  <div class="nod-view" :style="{ color: instruction.resolvedTheme.textColor }">
    ...
    <div class="guide">
      ...
      <!-- Vertical Layout (YES) -->
      <div class="toggle-track vertical" v-if="instruction.options.type !== 'NO' && instruction.options.showSwitch" 
      ...
      <div class="toggle-track horizontal" v-if="instruction.options.type === 'NO' && instruction.options.showSwitch"
           :style="{ borderColor: instruction.resolvedTheme.secondaryTextColor }">
        <div class="toggle-thumb" 
             :style="{ 
      ...
      <!-- Progress Bar -->
      <div v-if="instruction.options.showProgress" class="progress-container" :style="{ backgroundColor: instruction.resolvedTheme.accentColor + '1A' }">
