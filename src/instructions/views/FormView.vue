...
const accentHoverColor = computed(
	() =>
		props.instruction.resolvedTheme.accentHoverColor ||
		props.instruction.resolvedTheme.accentColor
)
...
<template>
	<div
		class="form-instruction-view p-8 mx-auto"
	...
	>
		...
		>
			<div
				v-for="field in instruction.fields"
				:key="field.name"
			>
				<label
					:for="field.name"
